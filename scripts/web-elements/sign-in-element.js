            ...
            <div data-js-tag="sign-in-holder" class="sign-in-holder"></div>
                <div class="welcome--sign-in">
                    <a href="#signin" title="Learn">
                        <button class="no-bg-button" data-js-tag="toggle-signinup"><img class="nice-button si-button-image" src="./components/visuals/icons/sign-in/new-user/${window.TTC.theme}${this.imageExtension}" alt=""></button>
                    </a>
                        ...
                        <div data-js-tag="sign-in" class="sign-in">
                            ...
                            <div class="si-button-flexbox">
                                <button data-js-tag="exit-button" class="si-exit main-font nice-button no-bg-button">
                                    <img style="width: 30px; height: 30px;" data-js-tag="close-img" src='./components/visuals/icons/project/close/${window.TTC.theme}${this.imageExtension}'>
                                </button>
