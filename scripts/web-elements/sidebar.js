        ...
        <div class="sidebar-element">
            ...
            <div class="dropdown">
                <ul class="dropdown--list">
                    ...
                    <li class="dropdown--element"><a href="signin.html" title="Settings">
                        <img class="dropdown--image nice-button dark-glow rotate-45" src="${this.iconPath}/sign-in/${this.theme}${this.imageExtension}" alt="Settings" draggable="false">
                    </a></li>
                </ul>
            </div>
